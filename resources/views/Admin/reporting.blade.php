        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <p class="mb-4">Berikut adalah data dari penjualan dan peminjaman</a>.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="container">
                                    <p>Reporting Untuk Penjualan</p>
                                    <a href="/admin/reportingpenjualan" class="btn btn-primary">Lihat Reporting Penjualan</a>
                                    <br><br>
                                    <p>Reporting Untuk Peminjaman</p>
                                    <a href="/admin/reportingpeminjaman" class="btn btn-primary">Lihat Reporting Peminjaman</a>
                                </div>
                            </div>
                        </div>
