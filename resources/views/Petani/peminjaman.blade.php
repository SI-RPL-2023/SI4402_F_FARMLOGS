                    ...
                    <div class="row text-left">
                        <div class="col-sm-12 mb-3">
                            <div class="before" id="before" style="display: block;">
                                <label class="custom-file-upload">
                                    ...
                                    <p style="color:#373737;">Foto Data Diri (KTP)</p>
                                    <input type="file" onchange="loadFile(this)" id="ktp" name="ktp" class="form-control-file">
                                </label>
                            </div>
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="before" id="before" style="display: block;">
                                <label class="custom-file-upload">
                                    <i class="fa-solid fa-plus" style="color:#5B5B5B;font-size:50px;"></i>
                                    <p style="color:#373737;">Foto Lahan Tani</p>
                                    <input type="file" onchange="loadFile(this)" id="lahan" name="lahan" class="form-control-file">
                                </label>
                            </div>
                            <div class="after" id="after" style="display: none;">
                                <center>
